                        ...
                        <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                            <form className="flex flex-col relative md:col-span-3">
                                ...
                                <input
                                    type="search"
                                    id="default-search"
                                    className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-100 rounded bg-gray-50"
                                    placeholder="Search here..."
                                    required
                                />
                                <button
                                    type="submit"
                                    className="text-blue-500 absolute end-2.5 top-1.5 border border-blue-500 hover:bg-blue-50 focus:outline-none font-medium rounded text-base px-4 py-2"
                                >
                                    Search
                                </button>
                            </form>
